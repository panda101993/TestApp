...
import { Country } from "../../components/globalComponents/countrycode";
...
export default class SignUp extends Component {
    ...
    SignupApi() {
        ...
        ApiRequest(SigninDetails, "/SignUp", "POST")
            .then(async resp => {
    ...
    SignupSubmit() {
        ...
        else { this.setState({ nameError: '*Please enter name.', nameStatus: false, activefirstnameBorderColor: true }) }
                            ...
                            <View style={style.TextInputMainContainer}>
                                ...
                                <View style={style.MobileNumberCountryCodeView}>
                                    ...
                                    <CustomTextInput
                                        ...
                                        textInputStyle={{ paddingLeft: 20, width: wp('55%'), height: hp('8%'), marginRight: wp('12%') }}
                                ...
                                <View style={style.TermAndConditionView}>
                                    ...
                                    <TouchableOpacity
                                    //    onPress={() =>this.props.navigation.navigate("TermandConditionScreen") }
                                    >
